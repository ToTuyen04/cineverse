...
const StatusChip = ({ available }) => {
  ...
  return (
    <Chip 
      ...
      size="small" 
      sx={{ 
        bgcolor: available ? alpha(theme.palette.success.main, 0.1) : alpha(theme.palette.error.main, 0.1),
...
const TypeChip = ({ type }) => {
  ...
  // Convert to number to ensure consistent comparison (handles "0" and 0)
  const typeNum = Number(type);
  
  return (
    <Chip 
      label={typeNum === 0 ? 'Thức ăn' : 'Nước'} 
      size="small" 
      sx={{ 
        bgcolor: typeNum === 0 
